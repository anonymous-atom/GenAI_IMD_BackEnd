...
from sentiment_posterv2.mobilefacenet import MobileFaceNet
from sentiment_posterv2.ir50 import Backbone
from sentiment_posterv2.vit_model import VisionTransformer, PatchEmbed
...
class pyramid_trans_expr2(nn.Module):
    def __init__(self, img_size=224, num_classes=7, window_size=[28, 14, 7], num_heads=[2, 4, 8], dims=[64, 128, 256],
        ...
        face_landback_checkpoint = torch.load(
            '/home/karun/PycharmProjects/GenAI_IMD_BackEnd/sentiment_posterv2/pretrain/mobilefacenet_model_best.pth.tar',
        ...
        ir_checkpoint = torch.load('/home/karun/PycharmProjects/GenAI_IMD_BackEnd/sentiment_posterv2/pretrain/ir50.pth',
                                   map_location=lambda storage, loc: storage)
